<script type="text/javascript">
    RED.nodes.registerType('phidget22-gps',{
        category: 'Phidgets',
        color: '#a6bbcf',
        defaults: {
            channel: {value: 0 },
...
<script type="text/x-red" data-template-name="phidget22-gps">
...
<script type="text/x-red" data-help-name="phidget22-gps">
    <p>Opens a Phidget GPS object, which will send messages when the heading or position changes.</p>
</script>