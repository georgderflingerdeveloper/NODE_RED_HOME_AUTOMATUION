<script type="text/javascript">
    RED.nodes.registerType('phidget22-lcd',{
        ...
        label: function() {
            return "LCD(" + this.channel + ")";
        },
        paletteLabel: "LCD",
        oneditprepare: function() {
            var prevSize= this.screenSize;
            $.getScript('phidget22/js/phidget22.min.js').done(function(data,textStatus,jqxhr){

                for (var key in phidget22.LCDScreenSize) {
...
<script type="text/x-red" data-template-name="phidget22-lcd">
    ...
    <div class="form-row">
        ...
        <select id="node-input-screenSize">
        </select>
    </div>
...
<script type="text/x-red" data-help-name="phidget22-lcd">
    <p>Opens a Phidget LCD object, which will receive messages to write text or graphics on the LCD screen.</p>
</script>