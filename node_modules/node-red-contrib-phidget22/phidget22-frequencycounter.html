<script type="text/javascript">
    RED.nodes.registerType('phidget22-frequencycounter',{
        ...
        label: function() {
            return "FrequencyCounter(" + this.channel + ")";
        },
        paletteLabel: "FrequencyCounter",
        oneditprepare: function() {
            var prevFilter = this.filterType;
            var prevMode = this.inputMode;
...
<script type="text/x-red" data-help-name="phidget22-frequencycounter">
    <p>Opens a Phidget frequency counter object, which will send messages when the frequency value changes.</p>
</script>