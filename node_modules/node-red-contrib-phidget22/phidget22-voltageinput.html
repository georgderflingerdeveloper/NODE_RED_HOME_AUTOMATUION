...
<script type="text/x-red" data-template-name="phidget22-voltageinput">
    ...
    <div class="form-row">
        ...
        <select id="node-input-voltageRange">
        </select>
    </div>
...
<script type="text/x-red" data-help-name="phidget22-voltageinput">
    <p>Opens a Phidget voltage input object, which will send messages when the voltage changes.</p>
</script>