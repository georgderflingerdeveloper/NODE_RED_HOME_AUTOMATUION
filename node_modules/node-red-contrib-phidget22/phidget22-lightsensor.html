<script type="text/javascript">
    RED.nodes.registerType('phidget22-lightsensor',{
        category: 'Phidgets',
        color: '#a6bbcf',
        defaults: {
            channel: {value: 0 },
            ...
            hubPort: {value: 0},
            illuminanceChangeTrigger:{value: 0}
        },
        inputs:1,
        outputs:1,
        icon: "phidgetlogo.png",
        label: function() {
            return "LightSensor(" + this.channel + ")";
        },
        paletteLabel: "LightSensor",
        
    });
</script>

<script type="text/x-red" data-template-name="phidget22-lightsensor">
    ...
    <div class="form-row">
        <label for="node-input-illuminanceChangeTrigger"><i class="icon-tag"></i> Change Trigger</label>
        <input type="text" id="node-input-illuminanceChangeTrigger">
    </div>
...
<script type="text/x-red" data-help-name="phidget22-lightsensor">
    <p>Opens a Phidget light sensor object, which will send messages when the sensor value changes.</p>
</script>