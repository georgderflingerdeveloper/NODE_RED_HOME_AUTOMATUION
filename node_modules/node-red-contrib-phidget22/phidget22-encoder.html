<script type="text/javascript">
    RED.nodes.registerType('phidget22-encoder',{
        ...
        label: function() {
            return "Encoder(" + this.channel + ")";
        },
        paletteLabel: "Encoder",
        oneditprepare: function() {
            var prevMode = this.IOMode;
...
<script type="text/x-red" data-help-name="phidget22-encoder">
    <p>Opens a Phidget encoder object, which will output a message whenever the encoder position changes.</p>
</script>