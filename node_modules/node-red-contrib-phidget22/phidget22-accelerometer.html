<script type="text/javascript">
    RED.nodes.registerType('phidget22-accelerometer',{
        category: 'Phidgets',
        color: '#a6bbcf',
        defaults: {
            channel: {value: 0 },
            ...
            accelerationChangeTrigger:{value: 0}
        },
        inputs:1,
        outputs:1,
        icon: "phidgetlogo.png",
        label: function() {
            return "Accelerometer(" + this.channel + ")";
        },
        paletteLabel: "Accelerometer",
    });
</script>

<script type="text/x-red" data-template-name="phidget22-accelerometer">
    ...
    <div class="form-row">
        <label for="node-input-accelerationChangeTrigger"><i class="icon-tag"></i> Change Trigger</label>
        <input type="text" id="node-input-accelerationChangeTrigger">
    </div>
...
<script type="text/x-red" data-help-name="phidget22-accelerometer">
    <p>Opens a Phidget accelerometer object, which will send messages when the acceleration changes.</p>
</script>