<script type="text/javascript">
    RED.nodes.registerType('phidget22-stepper',{
        ...
        label: function() {
            return "Stepper(" + this.channel + ")";
        },
        paletteLabel: "Stepper",
        oneditprepare: function() {
            var prevmode = this.controlMode;

            $.getScript('phidget22/js/phidget22.min.js').done(function(data,textStatus,jqxhr){

                for (var key in phidget22.StepperControlMode) {
...
<script type="text/x-red" data-help-name="phidget22-stepper">
    <p>Opens a Phidget Stepper object, which will receive messages to control the attached stepper motor.</p>
</script>