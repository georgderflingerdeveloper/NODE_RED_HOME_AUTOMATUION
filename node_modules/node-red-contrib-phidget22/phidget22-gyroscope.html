<script type="text/javascript">
    RED.nodes.registerType('phidget22-gyroscope',{
        category: 'Phidgets',
        color: '#a6bbcf',
        defaults: {
            channel: {value: 0 },
        ...
        label: function() {
            return "Gyroscope(" + this.channel + ")";
        },
        paletteLabel: "Gyroscope",
    });
</script>

<script type="text/x-red" data-template-name="phidget22-gyroscope">
...
<script type="text/x-red" data-help-name="phidget22-gyroscope">
    <p>Opens a Phidget gyroscope object, which will send messages when the angular rate changes.</p>
</script>